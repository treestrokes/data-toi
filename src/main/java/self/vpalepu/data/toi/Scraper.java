...
public class Scraper {
  ...
  public File scrape(DatedURL datedUrl, String storeRoot) {
    try {
      String url = datedUrl.generateURL();
      
      Document doc = Jsoup.connect(url).timeout(20*1000).get();
      File html = new File(storeRoot + datedUrl.getDateString() + ".html");
  ...
  public ArrayList<String> scrapeFrom(String storeRoot, LocalDate date, int forDays) 
  ...
  public ArrayList<String> scrapeFrom(String storeRoot, String ... dateStrings) 
      throws InterruptedException {
    ArrayList<String> failedDates = new ArrayList<>();
  ...
  public static void scrape(String storeRoot, String from, int forDays) throws IOException, InterruptedException {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    File html2013 = new File("/home/vijay/hackdata/toi/2013");
    File html2014 = new File("/home/vijay/hackdata/toi/2014");
    File html2015 = new File("/home/vijay/hackdata/toi/2015");
    File html2012 = new File("/home/vijay/hackdata/toi/2012");
    String storeRoot = "/home/vijay/hackdata/toi/2010-11/";
    File html2010_11 = new File(storeRoot);
//    html2010_11.mkdir();
//    Scraper.scrape(storeRoot, "2010-01-01", 730);
    
    File out = new File("/home/vijay/hackdata/toi/stories10-15.csv");
    Scraper.scrapeAndSpit(out, html2010_11, html2012, html2013, html2014, html2015);
  }
